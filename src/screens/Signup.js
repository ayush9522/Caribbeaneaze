...
export default function Signup() {
  return (
    ...
    <div style={{height: '90%',display:"flex",background:'white',width:window.innerWidth/2,justifyContent:'center',alignItems:'center'}}>
       ...
       <NavLink to='/TeamsCondition'><button style={{background: '#F15A29',width:'100%',height:64,marginTop:90,borderWidth:0,borderRadius:8,fontSize:25,color:'white',fontWeight:'500'}}>Register</button></NavLink>
